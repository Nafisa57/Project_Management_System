...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <nav className="flex items-center justify-between px-6 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#000000]">
                {/* Left: Logo */}
                <div className="flex items-center space-x-2">
                    <Link href="/" className="flex items-center">
                        ...
                        />
                        <span className="ml-2 font-semibold text-lg text-[#1b1b18] dark:text-[#EDEDEC]">
                            Project Management
                        </span>
                    </Link>
                </div>
                ...
                <div className="hidden md:flex items-center gap-6">
                    <Link
                        href="#features"
                        className="text-sm font-medium text-[#1b1b18] hover:text-[#1c5234] dark:text-[#EDEDEC] dark:hover:text-[#0e5230]"
                    >
                        Features
                    </Link>
                    <Link
